-- DROP DATABASE IF EXISTS SISInventario2;
-- CREATE DATABASE SISInventario2;
USE SISInventario2;
...
create table ordenes_compras(
    ...
    estadoOrden ENUM('Pendiente', 'Confirmada', 'Cancelada') NOT NULL,
    FOREIGN KEY (idProveedor) REFERENCES proveedores(idProveedor) ON DELETE CASCADE,
    FOREIGN KEY (idAlmacen) REFERENCES almacenes(idAlmacen) ON DELETE CASCADE
);
...
VALUES ('admin2', 'admin@appsistema.com', '$2a$10$lA3bnZiGmIW2Y1KzZjDnZeO4s4TvlseI1wCkDq6nh4TBakwDTBKkS', true, CURDATE());
...
SELECT idEmpresa FROM empresas WHERE nombre = 'Polleria-Wanka';
SELECT idUsuario FROM usuarios WHERE username = 'admin2';
...
INSERT INTO usuario_empresas (idUsuario, idEmpresa) VALUES (1, 2);